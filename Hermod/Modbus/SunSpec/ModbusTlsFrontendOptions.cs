...
/// <param name="ServerCertificateSelector">Asked at every handshake which certificate to show, given the SNI name the client sent. A frontend that has one of these can be given a new certificate without being restarted.</param>
...
public sealed record ModbusTlsFrontendOptions(
    ...
    Func<String?, X509Certificate2>?                     ServerCertificateSelector  = null,
