...
namespace org.GraphDefined.Vanaheimr.Hermod.DNS
{
    ...
    public class AAAA : ADNSResourceRecord
    {
        ...
        public static AAAA? TryParseFromJSON(DomainName Name, TimeSpan TimeToLive, String Data)
        {
            try { return new AAAA(Name, DNSQueryClasses.IN, TimeToLive, IPv6Address.Parse(Data)); }
            catch { return null; }
        }
