...
namespace org.GraphDefined.Vanaheimr.Hermod.DNS
{
    ...
    public class A : ADNSResourceRecord
    {
        ...
        /// </summary>
        public const DNSResourceRecordTypes TypeId = DNSResourceRecordTypes.A;
        ...
        public static A? TryParseFromJSON(DomainName Name, TimeSpan TimeToLive, String Data)
        {
            try { return new A(Name, DNSQueryClasses.IN, TimeToLive, IPv4Address.Parse(Data)); }
            catch { return null; }
        }
