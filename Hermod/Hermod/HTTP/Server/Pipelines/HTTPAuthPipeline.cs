...
namespace org.GraphDefined.Vanaheimr.Hermod.HTTP
{
    ...
    public static class HTTPAuthPipelineExtension
    {
        ...
        public static void AddHTTPAuthPipeline(this HTTPExtAPI  HTTPAPI,
    ...
    public class HTTPAuthPipeline(HTTPExtAPI  HTTPAPI,
                                  IUser?       DefaultUser                    = null,
                                  Byte?        RemoteAuthServersMaxHopCount   = null) : AHTTPPipeline()
    {
        ...
        private readonly HTTPExtAPI HTTPAPI = HTTPAPI;
