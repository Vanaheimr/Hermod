...
namespace org.GraphDefined.Vanaheimr.Hermod.HTTP
{
    ...
    public static class HTTPStandardHandlersX
    {
        ...
        private static async Task FileWasChanged(HTTPAPIX            HTTPAPI,
        ...
        private static async Task FileWasRenamed(HTTPAPIX            HTTPAPI,
                                                 HTTPEventSource_Id  EventSourceId,
                                                 String              NewFileName,
                                                 String              OldFileName)
        ...
        private static async Task FileWatcherError(HTTPAPIX            HTTPAPI,
                                                   HTTPEventSource_Id  EventSourceId,
        ...
        /// <param name="ResourceAssembly">Optionally the assembly where the resources are located (default: the calling assembly).</param>
        /// <param name="DefaultFilename">The default file to load.</param>
        public static void MapResourceAssemblyFolder(this HTTPExtAPIX               HTTPExtAPI,
                                                     HTTPHostname                   Hostname,
                                                     HTTPPath                       URLTemplate,
                                                     String                         ResourcePath,
                                                     Assembly?                      ResourceAssembly        = null,
        ...
        /// <param name="ResourceAssemblies">The assemblies where the resources are located.</param>
        /// <param name="DefaultFilename">The default file to load.</param>
        public static void MapResourceAssembliesFolder(this HTTPExtAPIX               HTTPExtAPI,
                                                       HTTPHostname                   Hostname,
                                                       HTTPPath                       URLTemplate,
                                                       Tuple<String, Assembly>[]      ResourceAssemblies,
                                                       String                         DefaultFilename         = "index.html",
        ...
        /// <param name="ResourcePath">The path to the file within the local file system.</param>
        /// <param name="DefaultFilename">The default file to load.</param>
        public static void MapFileSystemFolder(this HTTPAPIX                  HTTPAPI,
                                               HTTPHostname                   Hostname,
                                               HTTPPath                       URLTemplate,
                                               String                         ResourcePath,
                                               String                         DefaultFilename          = "index.html",
        ...
        /// <param name="DefaultFilename">The default file to load.</param>
        /// <param name="RequireAuthentication">Whether a HTTP authentication is required for downloading the files.</param>
        public static void MapFileSystemFolder(this HTTPExtAPIX               HTTPExtAPI,
                                               HTTPHostname                   Hostname,
                                               HTTPPath                       URLTemplate,
                                               String                         ResourcePath,
                                               String                         DefaultFilename          = "index.html",
        ...
        #region RegisterResourcesFile   (this HTTPAPI,           URLTemplate, ResourceAssembly, ResourceFilename, ResponseContentType = null, CacheControl = "no-cache")
        ...
        public static void RegisterResourcesFile(this HTTPAPIX         HTTPAPI,
                                                 HTTPHostname          Hostname,
                                                 HTTPPath              URLTemplate,
                                                 Assembly              ResourceAssembly,
        ...
        /// <param name="ResponseContentType">Set the HTTP MIME content-type of the file. If null try to autodetect the content type based on the filename extension.</param>
        /// <param name="CacheControl">Set the HTTP cache control response header.</param>
        public static void RegisterFileSystemFile(this HTTPAPIX           HTTPAPI,
                                                  HTTPHostname            Hostname,
                                                  HTTPPath                URLTemplate,
