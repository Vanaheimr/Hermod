...
namespace org.GraphDefined.Vanaheimr.Hermod.HTTP
{
    ...
    /// </summary>
    public class URL_NodeX : IEnumerable<HTTPMethodNodeX>
    {
        ...
        /// </summary>
        private readonly ConcurrentDictionary<HTTPMethod, HTTPMethodNodeX> httpMethodNodes = new();
        ...
        /// </summary>
        public IEnumerable<HTTPMethodNodeX>              HTTPMethodNodes
        ...
        internal URL_NodeX(HTTPAPI             HTTPAPI,
        ...
        /// </summary>
        /// <param name="Method">An HTTP method.</param>
        public HTTPMethodNodeX? Get(HTTPMethod Method)
        {
        ...
        public Boolean TryGet(HTTPMethod Method, [NotNullWhen(true)] out HTTPMethodNodeX? MethodNode)
        ...
        /// Return all HTTP method nodes.
        /// </summary>
        public IEnumerator<HTTPMethodNodeX> GetEnumerator()
