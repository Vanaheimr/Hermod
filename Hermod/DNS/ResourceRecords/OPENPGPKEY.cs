...
namespace org.GraphDefined.Vanaheimr.Hermod.DNS
{
    ...
    public class OPENPGPKEY : ADNSResourceRecord
    {
        ...
        public static OPENPGPKEY? TryParseFromJSON(DomainName Name, TimeSpan TimeToLive, String Data)
        {
            try { return new OPENPGPKEY(Name, DNSQueryClasses.IN, TimeToLive, Convert.FromBase64String(Data)); }
            catch { return null; }
        }
