...
namespace org.GraphDefined.Vanaheimr.Hermod.DNS
{
    ...
    public class CNAME : ADNSResourceRecord
    {
        ...
        public static CNAME? TryParseFromJSON(DomainName Name, TimeSpan TimeToLive, String Data, DomainName? Origin = null)
        {
            try
            {
                var target = Data;
                return new CNAME(Name, DNSQueryClasses.IN, TimeToLive, DNS.DomainName.ParseLenient(target, Origin));
            }
            catch { return null; }
        }
