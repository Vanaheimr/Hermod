...
namespace org.GraphDefined.Vanaheimr.Hermod.DNS
{
    ...
    public class MX : ADNSResourceRecord
    {
        ...
        public static MX? TryParseFromJSON(DomainName Name, TimeSpan TimeToLive, String Data, DomainName? Origin = null)
        {
            try
            {
                ...
                return new MX(Name, DNSQueryClasses.IN, TimeToLive, preference, DNS.DomainName.ParseLenient(exchange, Origin));
            }
            catch { return null; }
        }
