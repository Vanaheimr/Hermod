...
//        /// </summary>
//        ConnectionIdBuilder               ConnectionIdBuilder               { get; set; }

//        /// <summary>
//        /// A delegate to set the name of the TCP connection threads.
//        /// </summary>
//        ConnectionThreadsNameBuilder      ConnectionThreadsNameBuilder      { get; set; }

//        /// <summary>
//        /// A delegate to set the priority of the TCP connection threads.
//        /// </summary>
//        ConnectionThreadsPriorityBuilder  ConnectionThreadsPriorityBuilder  { get; set; }
...
//        /// </summary>
//        UInt32                            MaxClientConnections              { get; set; }
