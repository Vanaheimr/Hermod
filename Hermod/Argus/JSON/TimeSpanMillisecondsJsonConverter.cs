...
namespace org.GraphDefined.Vanaheimr.Hermod.Argus
{
    ...
    public class TimeSpanMillisecondsJsonConverter : JsonConverter<TimeSpan>
    {
        ...
        public override TimeSpan Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
            ...
            return reader.TokenType switch
            {
                ...
                _                     => throw new JsonException("TimeSpan values must be encoded as milliseconds or as a valid TimeSpan string!")
