...
namespace org.GraphDefined.Vanaheimr.Hermod.HTTP
{
    ...
    /// </summary>
    public abstract class AHTTPExtAPIExtension2<THTTPAPI2, THTTPAPI> : AHTTPAPIBase

        where THTTPAPI  : HTTPExtAPI
        where THTTPAPI2 : AHTTPExtAPIExtension1<THTTPAPI>

    {
        ...
        public AHTTPExtAPIExtension2(THTTPAPI2                HTTPAPI,
            ...
            : base(Description ?? I18NString.Create("A HTTPExt API Extension"),
                   URLPathPrefix,
                   BasePath,
                   //HTMLTemplate,
