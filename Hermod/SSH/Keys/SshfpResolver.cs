...
namespace org.GraphDefined.Vanaheimr.Hermod.SSH
{
    ...
    /// <summary>The result of an SSHFP lookup: the records found and whether the DNS answer was DNSSEC-authenticated.</summary>
    ...
    {
        /// <summary>An empty, unvalidated result.</summary>
    ...
    /// <summary>How much to trust SSHFP records for host-key verification (mirrors OpenSSH <c>VerifyHostKeyDNS</c>).</summary>
    public enum SshfpTrust
    {
        /// <summary>Ignore SSHFP entirely.</summary>
        Off,
        /// <summary>SSHFP never auto-accepts; a match only annotates the TOFU decision.</summary>
        Advisory,
        /// <summary>Auto-accept a matching record only when the answer was DNSSEC-validated.</summary>
        RequireDnssec
    }


    /// <summary>The outcome of matching a host key against its SSHFP records under a trust mode.</summary>
    public enum SshfpVerdict
    {
        /// <summary>No SSHFP records were published (or trust is Off) — SSHFP has no opinion.</summary>
        NoRecords,
        /// <summary>A record matched and the answer was DNSSEC-validated — safe to auto-accept.</summary>
        SecureMatch,
        /// <summary>A record matched but the answer was not validated — advisory only, never auto-accept.</summary>
        InsecureMatch,
        /// <summary>Records exist but none match the presented key — reject.</summary>
        Mismatch
    }


    /// <summary>Verifies a presented host key against its published SSHFP records under a <see cref="SshfpTrust"/> mode.</summary>
    public sealed class SshfpVerifier
    {
        ...
        /// <summary>Create a verifier over a resolver and a trust mode.</summary>
        ...
        /// <summary>Look up and evaluate the SSHFP records for the host against the presented key blob.</summary>
    ...
    /// <summary>An in-memory <see cref="ISshfpResolver"/> for tests and demos: map host → records + a DNSSEC flag.</summary>
    public sealed class InMemorySshfpResolver : ISshfpResolver
    {
        ...
        /// <summary>Publish records for a host (optionally marked DNSSEC-validated).</summary>
        ...
        /// <summary>Publish the records derived from a host key for a host.</summary>
