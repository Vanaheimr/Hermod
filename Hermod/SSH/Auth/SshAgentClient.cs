...
namespace org.GraphDefined.Vanaheimr.Hermod.SSH
{
    ...
    /// <summary>
    /// One identity held by an ssh-agent: its public-key wire blob and comment.
    /// </summary>
    ...
    public sealed class SshAgentClient : IAsyncDisposable
    {
        ...
        /// <summary>
        /// The <c>SSH_AGENT_RSA_SHA2_256</c> signing flag.
        /// </summary>
        public const UInt32 FlagRsaSha2_256 = 2;
        /// <summary>
        /// The <c>SSH_AGENT_RSA_SHA2_512</c> signing flag.
        /// </summary>
        ...
        /// <summary>
        /// Create an agent client over an already-connected stream.
        /// </summary>
        ...
        /// <summary>
        /// Connect to the platform ssh-agent (Windows named pipe or <c>SSH_AUTH_SOCK</c>).
        /// </summary>
        ...
        /// <summary>
        /// List the identities the agent holds.
        /// </summary>
        ...
        /// <summary>
        /// Ask the agent to sign <paramref name="Data"/> with the identity <paramref name="PublicKeyBlob"/>.
        /// </summary>
        ...
        /// <summary>
        /// Wrap one agent-held identity as an <see cref="ISshHostKey"/> signer for public-key auth.
        /// </summary>
    ...
    /// <summary>
    /// Thrown on an ssh-agent protocol error.
    /// </summary>
