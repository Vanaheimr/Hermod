...
namespace org.GraphDefined.Vanaheimr.Hermod.WebSocket
{
    ...
    //public delegate Task OnWebSocketServerTextMessageDelegate  (DateTimeOffset               Timestamp,
    ...
    //public delegate Task OnWebSocketServerBinaryMessageDelegate(DateTimeOffset               Timestamp,
    //                                                            AWebSocketServer             Server,
    //                                                            WebSocketServerConnection    Connection,
    //                                                            EventTracking_Id             EventTrackingId,
    //                                                            DateTimeOffset               RequestTimestamp,
    ...
    public interface IWebSocketServer
    {
        ...
        //Task ProcessTextMessage  (DateTimeOffset             RequestTimestamp,
        //                          WebSocketServerConnection  Connection,
        //                          String                     TextMessage,
        //                          EventTracking_Id           EventTrackingId,
        //                          CancellationToken          CancellationToken);
        ...
        ///// <param name="EventTrackingId">An optional event tracking identification for correlating this request with other events.</param>
        ///// <param name="CancellationToken">A token to cancel the processing.</param>
        //Task ProcessBinaryMessage(DateTimeOffset             RequestTimestamp,
        //                          WebSocketServerConnection  Connection,
        //                          Byte[]                     BinaryMessage,
        //                          EventTracking_Id           EventTrackingId,
        //                          CancellationToken          CancellationToken);
        ...
        /// </summary>
        /// <param name="EventTrackingId">An optional event tracking identification for correlating this request with other events.</param>
        Task Start(EventTracking_Id? EventTrackingId = null);

        /// <summary>
        /// Stop the HTTP WebSocket listener thread.
        /// </summary>
        /// <param name="EventTrackingId">An optional event tracking identification for correlating this request with other events.</param>
        /// <param name="Message">An optional message to include in the TCP server stopped event.</param>
        Task Stop(EventTracking_Id?  EventTrackingId   = null,
                  String?            Message           = null);
