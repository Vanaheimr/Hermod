...
namespace org.GraphDefined.Vanaheimr.Hermod.Tests.DNS
{
    ...
    /// </summary>
    [TestFixture]
    public class CloudflareTCP_Tests
    {
        ...
        #region CloudflareTCP_charging_cloud__A()

        [Test]
        public async Task CloudflareTCP_charging_cloud__A()
        {
        ...
        #region CloudflareTCP_charging_cloud__AAAA()

        [Test]
        public async Task CloudflareTCP_charging_cloud__AAAA()
        {
        ...
        #region CloudflareTCP_charging_cloud__MX()

        [Test]
        public async Task CloudflareTCP_charging_cloud__MX()
        {
        ...
        #region CloudflareTCP_charging_cloud__TXT()

        [Test]
        public async Task CloudflareTCP_charging_cloud__TXT()
        {
        ...
        #region CloudflareTCP_open_charging_cloud__A()

        [Test]
        public async Task CloudflareTCP_open_charging_cloud__A()
        {
        ...
        #region CloudflareTCP_open_charging_cloud__AAAA()

        [Test]
        public async Task CloudflareTCP_open_charging_cloud__AAAA()
        {
        ...
        #region CloudflareTCP_open_charging_cloud__MX()

        [Test]
        public async Task CloudflareTCP_open_charging_cloud__MX()
        {
        ...
        #region CloudflareTCP__ocpp_tls_api_charging_cloud__SRV()

        [Test]
        public async Task CloudflareTCP_ocpp_tls_api_charging_cloud__SRV()
        {
