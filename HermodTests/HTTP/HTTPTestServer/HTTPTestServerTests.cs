...
namespace org.GraphDefined.Vanaheimr.Hermod.Tests.HTTP
{
    ...
    public class HTTPTestServerTests
    {
        ...
        #region HTTPTestServerTest_02()

        [Test]
        public async Task HTTPTestServerTest_02()
        {
            ...
            var trailers  = await response.Item2.ReadAllChunks(chunk => chunks.Add((sw.Elapsed, chunk.ToUTF8String())));
            chunks.Add((sw.Elapsed, "Finished!"));
            sw.Stop();
