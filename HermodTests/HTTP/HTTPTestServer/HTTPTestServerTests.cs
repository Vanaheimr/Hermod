...
namespace org.GraphDefined.Vanaheimr.Hermod.Tests.HTTP
{
    ...
    public class HTTPTestServerTests
    {
        ...
        public async Task ClientServer_HTTPServerSentEvents_Test01()
        {
            ...
            var sse1x       = httpAPI.GetEventSource(sse1Id);
        ...
        public async Task DNSSRV_Tests_01()
        {
            ...
            dnsClient.CacheSRV(DNSServiceName.Parse("_ocpp._tcp.api.example.local"), 10, 20, api1.HTTPServer.TCPPort, DomainName.Parse("api1.example.local"));
            dnsClient.CacheSRV(DNSServiceName.Parse("_ocpp._tcp.api.example.local"), 10, 80, api2.HTTPServer.TCPPort, DomainName.Parse("api2.example.local"));
            dnsClient.CacheSRV(DNSServiceName.Parse("_ocpp._tcp.api.example.local"), 20,  0, api3.HTTPServer.TCPPort, DomainName.Parse("api3.example.local"));
