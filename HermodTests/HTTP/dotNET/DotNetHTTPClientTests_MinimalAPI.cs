...
namespace org.GraphDefined.Vanaheimr.Hermod.Tests.HTTP
{
    ...
    /// <summary>
    /// Tests between .NET HTTP clients and .NET minimal web APIs.
    /// </summary>
    [TestFixture]
    public class DotNetHTTPClientTests_MinimalAPI : AMinimalDotNetWebAPI
    {
        ...
        private static void AssertBasicChallenge(HttpResponseMessage HTTPResponse)
        {
            ...
            Assert.That(
                HTTPResponse.Headers.WwwAuthenticate.Any(challenge => challenge.ToString() == BasicAuthenticationHandler.ChallengeHeaderValue),
                Is.True
            );
        ...
        public async Task Test_001()
        {
            ...
            Assert.That(httpResponse.Headers.Server.ToString(),   Is.EqualTo("Kestrel Test Server"));
