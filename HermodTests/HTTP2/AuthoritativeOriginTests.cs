...
namespace org.GraphDefined.Vanaheimr.Hermod.Tests.HTTP2
{
    ...
    public class AuthoritativeOriginTests
    {
        ...
        public async Task ForeignAuthority_Gets421()
        {
            ...
            var ours     = await conn.SendRequestAsync(HTTPMethod.GET, URIScheme.https, $"localhost:{srv.Port}",      "/");
            var foreign  = await conn.SendRequestAsync(HTTPMethod.GET, URIScheme.https, $"evil.example:{srv.Port}",   "/");
            var loopback = await conn.SendRequestAsync(HTTPMethod.GET, URIScheme.https, $"127.0.0.1:{srv.Port}",      "/");
            ...
            var after = await conn.SendRequestAsync(HTTPMethod.GET, URIScheme.https, $"localhost:{srv.Port}", "/");
        ...
        public async Task ForeignAuthority_Gets421_OnTheStreamingPath()
        {
            ...
            var foreign = await conn.SendRequestAsync(HTTPMethod.GET, URIScheme.https, "evil.example", "/");
            var ours    = await conn.SendRequestAsync(HTTPMethod.GET, URIScheme.https, $"localhost:{srv.Port}", "/");
        ...
        public async Task AuthorityCheck_CanBeOpenedUp()
        {
            ...
            var foreign = await conn.SendRequestAsync(HTTPMethod.GET, URIScheme.https, "anything.example", "/");
        ...
        public async Task CleartextH2c_HasNoAuthorityToCheckAgainst()
        {
            ...
            var foreign = await conn.SendRequestAsync(HTTPMethod.GET, URIScheme.http, "anything.example", "/");
        ...
        public async Task OriginFrame_IsAnnouncedAndReceived()
        {
            ...
            var alpha   = await conn.SendRequestAsync(HTTPMethod.GET, URIScheme.https, "alpha.example",       "/");
            var beta    = await conn.SendRequestAsync(HTTPMethod.GET, URIScheme.https, "beta.example:8443",   "/");
            var dialed  = await conn.SendRequestAsync(HTTPMethod.GET, URIScheme.https, $"localhost:{srv.Port}", "/");
        ...
        public async Task OriginFrame_IsIgnoredOverCleartext()
        {
            ...
            var alpha = await conn.SendRequestAsync(HTTPMethod.GET, URIScheme.http, "alpha.example", "/");
