...
namespace org.GraphDefined.Vanaheimr.Hermod.Tests.HTTP2
{
    ...
    public class ClientTrailerTests
    {
        ...
        public async Task OurServer_ReceivesRequestTrailers()
        {
            ...
            var stream = await conn.StartStreamingRequestAsync(HTTPMethod.POST, URIScheme.https, $"localhost:{srv.Port}", "/echo");
        ...
        public async Task NoTrailers_StillEndsTheRequestTheOldWay()
        {
            ...
            var empty  = await conn.StartStreamingRequestAsync(HTTPMethod.POST, URIScheme.https, $"localhost:{srv.Port}", "/echo");
        ...
        public async Task InvalidTrailers_NeverReachTheWire()
        {
            ...
            var pseudo = await conn.StartStreamingRequestAsync(HTTPMethod.POST, URIScheme.https, $"localhost:{srv.Port}", "/echo");
            ...
            var upper = await conn.StartStreamingRequestAsync(HTTPMethod.POST, URIScheme.https, $"localhost:{srv.Port}", "/echo");
            ...
            // must be unharmed.
            var ok = await conn.StartStreamingRequestAsync(HTTPMethod.POST, URIScheme.https, $"localhost:{srv.Port}", "/echo");
        ...
        public async Task Kestrel_ReadsOurRequestTrailers()
        {
            ...
            var stream = await conn.StartStreamingRequestAsync(HTTPMethod.POST, URIScheme.https, $"localhost:{kestrel.Port}", "/trailers");
