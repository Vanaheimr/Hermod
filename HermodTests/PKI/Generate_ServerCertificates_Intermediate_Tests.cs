...
namespace org.GraphDefined.Vanaheimr.Hermod.Tests.PKI
{
    ...
    /// </summary>
    [TestFixture]
    public class Generate_ServerCertificates_Intermediate_Tests
    {
                                                      ...
                                                      X509Certificate  ServerCertificate)
        {
            ...
            var issuerKeyIdentifier     = PKIFactory.ParseSubjectKeyIdentifier(IssuerCertificate);
            Assert.That(authorityKeyIdentifier!.KeyIdentifier?.GetOctets().ToHexString(),   Is.EqualTo(issuerKeyIdentifier!.GetKeyIdentifier().ToHexString()),             "AKI.keyIdentifier must match the rootCA SKI.keyIdentifier!");
        ...
        #region Generate_ECC_secp521r1_ServerCertificate_Intermediate_Test()

        /// <summary>
        /// Create a signed ECC secp521r1 server certificate (rootCA, intermediateCA).
        /// </summary>
        [Test]
        public void Generate_ECC_secp521r1_ServerCertificate_Intermediate_Test()
        {
            ...
            var serverCAKeyPair      = PKIFactory.GenerateECCKeyPair("secp521r1");
            ...
            var sans               = dotNetCertificate.DecodeSubjectAlternativeNames();
        ...
        #region Generate_ECC_ServerCertificate_Intermediate_Test()

        /// <summary>
        /// Create a signed ECC server certificate (rootCA, intermediateCA).
        /// </summary>
        [Test]
        public void Generate_ECC_ServerCertificate_Intermediate_Test()
        {
        ...
        #region Generate_Ed25519_ServerCertificate_Intermediate_Test()

        /// <summary>
        /// Create a signed Ed25519 server certificate (rootCA, intermediateCA).
        /// </summary>
        [Test]
        public void Generate_Ed25519_ServerCertificate_Intermediate_Test()
        {
            ...
            var serverCAKeyPair      = PKIFactory.GenerateEd25519KeyPair();
            var serverCACertificate  = PKIFactory.CreateIntermediateCA(
                                           SubjectName:             "Hermod ServerCA",
                                           IntermediatePublicKey:    serverCAKeyPair.Public,
                                           IssuerPrivateKey:         rootCAKeyPair.Private,
        ...
        #region Generate_Ed448_ServerCertificate_Intermediate_Test()

        /// <summary>
        /// Create a signed Ed448 server certificate (rootCA, intermediateCA).
        /// </summary>
        [Test]
        public void Generate_Ed448_ServerCertificate_Intermediate_Test()
        {
            ...
            var serverCAKeyPair      = PKIFactory.GenerateEd448KeyPair();
            var serverCACertificate  = PKIFactory.CreateIntermediateCA(
                                           SubjectName:             "Hermod ServerCA",
                                           IntermediatePublicKey:    serverCAKeyPair.Public,
                                           IssuerPrivateKey:         rootCAKeyPair.Private,
        ...
        #region Generate_MLDSA_ServerCertificate_Intermediate_Test()

        /// <summary>
        /// Create a signed ML-DSA server certificate (rootCA, intermediateCA).
        /// </summary>
        [Test]
        public void Generate_MLDSA_ServerCertificate_Intermediate_Test()
        {
            ...
            var serverCAKeyPair      = PKIFactory.GenerateMLDSAKeyPair();
            var serverCACertificate  = PKIFactory.CreateIntermediateCA(
                                           SubjectName:             "Hermod ServerCA",
                                           IntermediatePublicKey:    serverCAKeyPair.Public,
                                           IssuerPrivateKey:         rootCAKeyPair.Private,
        ...
        #region Generate_RSA_ServerCertificate_Intermediate_Test()

        /// <summary>
        /// Create a signed RSA server certificate (rootCA, intermediateCA).
        /// </summary>
        [Test]
        public void Generate_RSA_ServerCertificate_Intermediate_Test()
        {
            ...
            var serverCAKeyPair      = PKIFactory.GenerateRSAKeyPair();
            var serverCACertificate  = PKIFactory.CreateIntermediateCA(
                                           SubjectName:             "Hermod ServerCA",
                                           IntermediatePublicKey:    serverCAKeyPair.Public,
                                           IssuerPrivateKey:         rootCAKeyPair.Private,
        ...
        #region Generate_RSA2048_ServerCertificate_Intermediate_Test()

        /// <summary>
        /// Create a signed RSA2048 server certificate (rootCA, intermediateCA).
        /// </summary>
        [Test]
        public void Generate_RSA2048_ServerCertificate_Intermediate_Test()
        {
            ...
            var serverCAKeyPair      = PKIFactory.GenerateRSAKeyPair(2048);
            var serverCACertificate  = PKIFactory.CreateIntermediateCA(
                                           SubjectName:             "Hermod ServerCA",
                                           IntermediatePublicKey:    serverCAKeyPair.Public,
                                           IssuerPrivateKey:         rootCAKeyPair.Private,
